...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_text_5 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_row_1.v-row-padding--vertical { padding-top: 20px !important; padding-bottom: 20px !important; } }
    </style>
...
<table id="u_content_text_5" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 140%; font-size: 14px;"><strong style="font-size: 14px;"><span style="font-family: 'Open Sans', sans-serif; font-size: 28px; line-height: 39.2px;"><span style="color: #f1c40f; line-height: 39.2px; font-size: 28px;">Thanks For Subscribing </span></span></strong><span style="font-family: 'Open Sans', sans-serif; font-size: 14px; line-height: 19.6px;"><span style="font-size: 28px; line-height: 39.2px;"><strong>👋</strong></span></span></p>
  </div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://cdn.templates.unlayer.com/assets/1666174164387-new.gif" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600"/>
...
<div id="u_row_1" class="u-row-container v-row-padding--vertical" style="padding: 50px 0px;background-color: transparent">
  <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
    <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
